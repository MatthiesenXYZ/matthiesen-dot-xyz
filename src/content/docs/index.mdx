...
hero:
  ...
  actions:
    ...
    - text: Check our GitHub
      ...
      icon: external
---
import gitkrakenlogo from '../../assets/GitKraken_WebBanner.webp'
...
<CardGrid stagger>
	...
	<Card title="Keeping our Git Workflow organized is">
		[<img src={gitkrakenlogo.src} width="225px" height="50px" title="Maintained with GitKraken" alt="Maintained with GitKraken"/>](https://www.gitkraken.com/invite/hirocQWn)
	</Card>
</CardGrid>